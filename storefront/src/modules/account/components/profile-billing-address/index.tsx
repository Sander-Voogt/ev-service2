...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  const currentInfo = useMemo(() => {
    if (!billingAddress) {
      return "Geen factuuradres ingesteld"
    }
    ...
    return (
      <div className="flex flex-col font-semibold text-neutral-900" data-testid="current-info">
        <span>
          {billingAddress.first_name} {billingAddress.last_name}
        </span>
        {billingAddress.company && <span className="text-gray-600">{billingAddress.company}</span>}
        <span>
