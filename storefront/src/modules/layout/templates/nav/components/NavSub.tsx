...
export default function NavSub() {
  return (
    <div className="hidden small:flex items-center gap-x-6 h-full">
      <LocalizedClientLink
        className="flex items-center gap-1 text-text-base hover:text-jade transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jade rounded px-1"
        href="/search"
        scroll={false}
